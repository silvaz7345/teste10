-- MAGNET BLOCKS - Símbolo 卐 seguro
...
-- CONFIG
local magnet = false
local safeHeight = 3 -- altura mínima acima do personagem
...
local offsets = {
    Vector3.new(0,5,0), Vector3.new(0,4,0), Vector3.new(0,3,0), Vector3.new(0,2,0), Vector3.new(0,1,0),
    Vector3.new(1,5,0), Vector3.new(2,5,0), Vector3.new(3,5,0),
    Vector3.new(1,3,0), Vector3.new(2,3,0),
    Vector3.new(3,2,0), Vector3.new(3,1,0),
}

-- Posicionar bloco com física estável e segura
local function controlBlock(block, targetPos)
    ...
    -- Ajusta altura segura usando raycast
...
RunService.Heartbeat:Connect(function()
    if magnet then
        local list = getAllBlocks() -- pega todos os blocos
